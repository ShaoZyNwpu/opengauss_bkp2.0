...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    WITH_TIME = 1013,
    INCLUDING_ALL = 1014,
    RENAME_PARTITION = 1015,
    PARTITION_FOR = 1016,
    SUBPARTITION_FOR = 1017,
    ADD_PARTITION = 1018,
    DROP_PARTITION = 1019,
    REBUILD_PARTITION = 1020,
    MODIFY_PARTITION = 1021,
    ADD_SUBPARTITION = 1022,
    DROP_SUBPARTITION = 1023,
    NOT_ENFORCED = 1024,
    VALID_BEGIN = 1025,
    DECLARE_CURSOR = 1026,
    ON_UPDATE_TIME = 1027,
