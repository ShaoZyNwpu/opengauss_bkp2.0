...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_double_write",
            ...
            NULL,
            NULL},
        {{"enable_backend_flush_dirty_page",
            PGC_POSTMASTER,
            NODE_ALL,
            WAL_CHECKPOINTS,
            gettext_noop("Enable backend flush dirty page."),
            NULL,
            },
            &g_instance.attr.attr_storage.enable_backend_flush_dirty_page,
            false,
            NULL,
            NULL,
            NULL},
...
static void InitStorageConfigureNamesInt64()
{
    struct config_int64 localConfigureNamesInt64[] = {
        ...
        {{"adapt_period",
            ...
            NODE_ALL,
            RESOURCES_RECOVERY,
            gettext_noop("set period gap calculate mark buffer dirty sleep time"),
            NULL},
            &g_instance.attr.attr_storage.adapt_period,
            INT64CONST(1000000), // 1s
            INT64CONST(1),
            INT64CONST(2147483648),
            NULL,
            NULL,
            NULL},  
        /* End-of-list marker */
